  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-primary/5 via-green-500/5 to-emerald-500/5 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-7xl relative z-10">
        <div className="relative w-full min-h-[75vh] bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-3xl shadow-2xl flex border border-white/20 dark:border-gray-800/50">
          {/* LEFT SECTION */}
          <section className="w-1/2 bg-gradient-to-br from-green-600 via-green-500 to-emerald-500 text-white flex flex-col justify-between relative overflow-hidden p-12 rounded-l-3xl">
            ...
            <div className="relative z-10 flex flex-col h-full gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-2 justify-center mt-auto pt-3">
                  {[
                    "Employee Management",
                    "Payroll",
                    "Attendance",
                ...
                <div className="text-center mt-auto pt-6">
                  ...
                  <p className="text-sm text-white mt-1">
                    Powered by{" "}
                    <span className=" font-semibold text-sm">Urban Cruise</span>
                  </p>
                </div>
              </div>
            </div>
          ...
          {/*  RIGHT SECTION — overflow-visible so logo can go outside */}
          <section className="w-1/2 flex items-center justify-center bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 rounded-r-3xl relative overflow-visible">
            <div className="w-full max-w-md space-y-3  pt-48">
              {/*  Company Logo — half upar bahar, half andar */}
              <div className="flex justify-center items-center">
                <div className="absolute top-16 left-2/4 -translate-x-2/4 -translate-y-2/4 w-full max-w-md ">
                  <div className="bg-white rounded-2xl border border-gray-100 shadow-[0px_0px_25px_10px_rgba(0,0,0,0.1)] p-5">
                    <img
                      src={companylogo}
                      alt="Urban Cruise"
              ...
              {error && (
                <div className="group relative">
                  ...
                  <div className="relative flex items-center gap-3 rounded-xl px-4 py-3 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border border-red-200 dark:border-red-900/50 shadow-lg">
                    <AlertCircle
                      size={18}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative flex items-center">
                      ...
                      <input
                        ...
                        required
                        disabled={loading}
                        className="w-full pl-11 pr-4 h-12 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder:text-gray-400 focus:outline-none focus:border-green-600 focus:ring-2 focus:ring-green-600/20 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative flex items-center">
                      ...
                      <input
                        ...
                        required
                        disabled={loading}
                        className="w-full pl-11 pr-11 h-12 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder:text-gray-400 focus:outline-none focus:border-green-600 focus:ring-2 focus:ring-green-600/20 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                      />
                      <button
                        type="button"
                ...
                >
                  <div className="relative h-12 rounded-xl bg-gradient-to-r from-green-600 to-emerald-500 text-white font-semibold text-sm overflow-hidden">
